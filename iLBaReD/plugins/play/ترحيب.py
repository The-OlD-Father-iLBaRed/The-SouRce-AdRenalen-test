...
BUTTON = InlineKeyboardMarkup([InlineKeyboardButton("• ⌯ اضف البوت الي مجموعتك او قناتك ⌯ •", url=f"https://t.me/{app.username}?startgroup=true")]),parse_mode=enums.ParseMode.MARKDOWN)
